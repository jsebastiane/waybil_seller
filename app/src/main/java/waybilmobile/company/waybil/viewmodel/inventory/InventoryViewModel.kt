package waybilmobile.company.waybil.viewmodel.inventory
...
import waybilmobile.company.waybil.util.setSkuList
import java.util.*
...
class InventoryViewModel: ViewModel() {
    ...
    private fun createSkuList(){
        val skuList = ArrayList<String>()
        for (i in inventory){
            skuList.add(i.skuNumber.toLowerCase())
        }
        setSkuList(skuList)
    }
